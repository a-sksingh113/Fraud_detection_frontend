...
const BankDashboard = () => {
  ...
  const fetchLogs = async () => {
    try {
      const res = await axios.get(
        "https://api.ucohakethon.pixbit.me/api/admin/logs"
      );
  ...
  const fetchUsers = async () => {
    try {
      const res = await axios.get(
        "https://api.ucohakethon.pixbit.me/api/admin/users"
      );
            ...
            <div style={mainContentStyle}>
              <div style={cardStyle}>
                <h2 style={{ textAlign: "center", color: "white" }}>
                  Bank AI Fraud Detection Dashboard
                </h2>
                  ...
                  {logs.length === 0 ? (
                    ...
                    logs.map((log, index) => (
                      ...
                      >
                        ...
                        <p>
                          User Account Number: <strong>{log.userId}</strong>
                        </p>
                        ...
                        <p>
                          ...
                          <span
                            style={{
                              color: log.type === "fraud" ? "red" : "green",
                            }}
                          >
                            {log.message}
                          </span>
